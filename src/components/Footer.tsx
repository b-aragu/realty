              ...
              {socialLinks.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[0.45rem] tracking-[0.25em] uppercase text-white/20 group-hover:text-white/60 transition-colors duration-400">
                      {s.abbr}
                    </span>
                  </a>
                );
