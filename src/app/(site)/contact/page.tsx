          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-10">
                ...
                <div>
                    <a
                      href={`https://wa.me/254140530539?text=${encodeURIComponent(`Hello Wande Realty, I'm reaching out from your Contact page (${typeof window !== 'undefined' ? window.location.href : 'https://wanderealty.com/contact'}). I'd like to enquire about a property.`)}`}
                      target="_blank"
