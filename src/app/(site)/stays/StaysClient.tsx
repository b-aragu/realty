                  ...
                  <div className={`flex flex-col justify-center px-6 py-16 lg:py-0 ${isReverse ? 'lg:pl-[4rem] lg:pr-[4.5rem] lg:order-1' : 'lg:pl-[4.5rem] lg:pr-[4rem]'}`}>
                    <AnimatedSection delay={0.1}>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-[3rem] pt-[2rem] border-t border-[#dde1ee]">
                        <a 
                          href={`https://wa.me/254140530539?text=${encodeURIComponent(`Hi, I'm interested in booking ${stay.title} (${typeof window !== 'undefined' ? window.location.href : 'https://wanderealty.com/stays'}). Could you share more details?`)}`} 
                        ...
                        <a 
                          href={`https://wa.me/254140530539?text=${encodeURIComponent(`Hi, I have a general enquiry about your short-term stays (${typeof window !== 'undefined' ? window.location.href : 'https://wanderealty.com/stays'})`)}`} 
                          target="_blank" rel="noopener noreferrer" 
