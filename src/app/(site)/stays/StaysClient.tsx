                  ...
                  <div className={`flex flex-col justify-center px-6 py-16 lg:py-0 ${isReverse ? 'lg:pl-[4rem] lg:pr-[4.5rem] lg:order-1' : 'lg:pl-[4.5rem] lg:pr-[4rem]'}`}>
                    <AnimatedSection delay={0.1}>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-[3rem] pt-[2rem] border-t border-[#dde1ee]">
                        <a href={`https://wa.me/254140530539?text=${encodeURIComponent(stay.whatsappMessage || `Hi, I'm interested in booking ${stay.title}.`)}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-[0.9rem] text-[0.58rem] tracking-[0.28em] uppercase text-[#1c2340] transition-all duration-300 hover:text-[#2e4480] hover:gap-[1.4rem]">
                          Book This Stay
                          <span className="block w-[2rem] h-px bg-[#1c2340] transition-all duration-400" />
                        </a>
                        <a href="https://wa.me/254140530539" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-[0.5rem] text-[0.52rem] tracking-[0.24em] uppercase text-[#8b91a8] border-b border-transparent pb-px transition-colors duration-300 hover:text-[#25D366] hover:border-[#25D366]">
