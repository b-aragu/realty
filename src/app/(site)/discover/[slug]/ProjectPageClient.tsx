          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            <AnimatedSection>
              ...
              <div className="mt-11 flex flex-col sm:flex-row sm:items-center gap-8 lg:gap-12">
                ...
                <a href={`https://wa.me/254712678334?text=Hi, I'm interested in ${project.title}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[0.54rem] tracking-[0.24em] uppercase text-[#8b91a8] hover:text-[#25D366] transition-colors border-b border-transparent hover:border-[#25D366] pb-px">
            ...
            <AnimatedSection delay={0.2}>
              <div className="flex flex-col gap-0 border-t border-[#dde1ee]">
                <div className="flex flex-col py-5 border-b border-[#dde1ee] gap-1">
                  ...
                  <a href="tel:+254712678334" className="font-cormorant font-light text-base text-[#1c2340] hover:text-[#3a5299] transition-colors w-fit">+254 712 678 334</a>
                </div>
                <div className="flex flex-col py-5 border-b border-[#dde1ee] gap-1">
