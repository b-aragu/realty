...
export default function ProjectPageClient({ project }: { project: Project }) {
  ...
  return (
    <div className="bg-[#f8f7f4] font-montserrat font-extralight tracking-[0.04em] text-[#1c2340] overflow-x-hidden">
      ...
      <div className="fixed bottom-24 right-8 z-50 flex items-center bg-[#1c2340] text-white shadow-[0_4px_24px_rgba(28,35,64,0.35)] hover:shadow-[0_6px_32px_rgba(28,35,64,0.5)] transition-all duration-300">
        <a
