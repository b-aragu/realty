...
export const metadata: Metadata = {
  ...
  description:
    "Discover exclusive properties for rent or sale with Wande Realty, Kenya's premium real estate service provider. Luxury apartments, villas, and off-plan developments.",
  keywords: [
    "apartments for sale Nairobi",
    "property investment Kenya",
    "luxury apartments Nairobi",
    "off plan apartments Nairobi",
    "houses for sale Mombasa",
    "Wande Realty",
    "real estate Kenya",
  ],
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={cn(playfair.variable, inter.variable, "font-sans", geist.variable)}>
      <body className="bg-[#f5f8fa] text-[#131110] antialiased">
        <Navbar />
        ...
        <a
          href="https://wa.me/254712678334?text=Hello%20Wande%20Realty%2C%20I%27m%20interested%20in%20a%20property"
          target="_blank"
